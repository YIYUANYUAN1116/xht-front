...
import { login } from '@/services/ant-pro/api';
import { getFakeCaptcha } from '@/services/ant-pro/login';
import {
...
import { myLogin } from '@/services/oauth/api';
import { SET_TOKEN } from '@/utils/tokenUtil';
...
const Login: React.FC = () => {
  ...
  const handleSubmit = async (values: API.LoginParams) => {
    try {
      ...
      const msg =  await myLogin({...values});
          ...
          {type === 'mobile' && (
            <>
              <ProFormText
                fieldProps={{
                  size: 'large',
                  prefix: <MobileOutlined onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined} />,
                }}
                name="mobile"
                placeholder={intl.formatMessage({
